...
public final class DateUtil {
     ...
     * @return
     */
    public static int getDurationDays(LocalDateTime startDateTime, LocalDateTime endDateTime) {
        return (int)(endDateTime.toLocalDate().toEpochDay() - startDateTime.toLocalDate().toEpochDay());
    }

    /**
     * 将yyyy-MM-dd字符串转换成LocalDateTime
     *
     * @author TGB
     * @date 2021/07/13
     * @param date
